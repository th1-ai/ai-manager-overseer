---
name: ai-manager-overseer
description: Run AI Manager / Overseer ("The Warden") — The supervisor of the team.. Use when the user asks to run the agent, check what is waiting for review, approve or reject a draft, or asks how the agent is doing. Trigger phrases: "run The Warden", "/ai-manager-overseer", "check the queue", "what is waiting for me", "approve that draft".
---

# AI Manager / Overseer

Runs AI Manager / Overseer and works its review queue. Everything happens from the repo
